  ...
  export const regionData: Region[] = [
    {
      ...
      keyStrategicSectors: [
        { title: "Advanced Manufacturing", icon: "/opportunities/icons/city-01.png" },
        { title: "Aerospace & Defense", icon: "/opportunities/icons/spa.png" },
        { title: "Agriculture & Food", icon: "/opportunities/icons/tree/green.png" },
        { title: "Environment Services", icon: "/opportunities/icons/saudi-tree.png" },
        { title: "Logistics & Transport", icon: "/opportunities/icons/globe.png" },
        { title: "Healthcare & Pharma", icon: "/opportunities/icons/imd.png" },
        { title: "ICT & Digital", icon: "/opportunities/icons/radio.png" },
        { title: "Financial Services", icon: "/opportunities/icons/coins-01.png" },
      ],
      keyRegionalProjects: [
        {
          title: "NEOM",
    ...
    },
    {
      ...
      keyStrategicSectors: [
        { title: "Tourism & Hospitality", icon: "/opportunities/icons/city-01.png" },
        { title: "Religious Tourism", icon: "/opportunities/icons/spa.png" },
        { title: "Real Estate Development", icon: "/opportunities/icons/tree/green.png" },
    ...
    },
    {
      ...
      keyStrategicSectors: [
        { title: "Energy & Oil", icon: "/opportunities/opportunities/icons/city-01.png" },
        { title: "Petrochemicals", icon: "/opportunities/opportunities/icons/spa.png" },
        { title: "Logistics Hub", icon: "/opportunities/opportunities/icons/tree/green.png" },
        { title: "Industrial Parks", icon: "/opportunities/opportunities/icons/saudi-tree.png" },
        { title: "Port Development", icon: "/opportunities/opportunities/icons/globe.png" },
        { title: "Technology Sector", icon: "/opportunities/opportunities/icons/imd.png" },
        { title: "Mining & Minerals", icon: "/opportunities/opportunities/icons/radio.png" },
        { title: "Export Zones", icon: "/opportunities/opportunities/icons/coins-01.png" },
      ],
      keyRegionalProjects: [
        {
