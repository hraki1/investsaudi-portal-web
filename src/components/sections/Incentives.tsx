    ...
    <section className="relative py-16 md:py-24 overflow-hidden bg-linear-to-l from-[#001421] via-[#002338] to-[#3A2144]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-12 lg:px-20">
        ...
        <div className="mb-16 md:mb-20">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl lg:text-[46px] bukra-bold text-white mb-2">
              Incentives that Accelerate Success
            </h1>
            <p className="text-lg md:text-xl lg:text-[27px] text-gray-300 leading-relaxed bukra-regular">
        ...
        <div className="relative">
          ...
          <div className="relative mb-8 md:mb-20 pl-0 md:pl-24">
            ...
            <div className="relative overflow-hidden p-5 md:p-6 lg:p-[34px] rounded-[30px] bg-[linear-gradient(90deg,rgba(0,0,0,0.41)_0%,rgba(0,0,0,0.41)_100%)]">
              {/* Section Header */}
              <div className="mb-6 lg:mb-8 flex md:flex-row items-center justify-between gap-2">
                {/* content */}
                <div className="flex-1">
                  <h2 className="text-2xl md:text-[32px] bukra-regular text-white mb-2 lg:mb-4">
                    Incentive Categories
                  </h2>
                  <p className="text-[#F5F5F5] text-sm  md:text-base lg:text-lg max-w-3xl lg:max-w-none bukra-regular">
                ...
                {/* link */}
                <div>
                  <Link href="" className="text-white bukra-regular">
                    <svg
                      width="47"
                      height="47"
                      viewBox="0 0 47 47"
