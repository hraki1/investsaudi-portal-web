...
export default function Blogs() {
  ...
  return (
    ...
    >
      <div className="absolute bottom-0 left-0 w-[300px] h-[400px] md:w-3/2 md:h-[550px] lg:w-full overflow-hidden">
        <div
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-start">
          {/* Left Column - Content */}
          <div className="py-4 sm:py-6 md:py-10 my-auto lg:py-12">
