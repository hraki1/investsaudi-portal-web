            ...
            >
              {successStories.map((story) => (
                <SwiperSlide key={story.id} className="h-auto! stacked-slide">
                  <div
                    className={`w-[90vw]! min-[375px]:w-[85vw]! sm:w-[500px]! md:w-[550px]! lg:h-[600px]! xl:w-[650px]! 2xl:w-[900px]! h-full  rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 ${
                      story.gradient
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-2 h-full min-h-[280px] min-[375px]:min-h-[320px] sm:min-h-[380px] md:min-h-[420px] lg:min-h-[460px]">
                      {/* Left Panel - Image/Video */}
                      <div className="relative min-h-[180px] min-[375px]:min-h-[200px] sm:min-h-[240px] md:min-h-[280px] lg:h-[550px]">
                        <div className="relative h-full w-full">
                          ...
                          <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                            <button className="w-10 h-10 min-[375px]:w-12 min-[375px]:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-black/50 backdrop-blur-sm border-2 border-white/30 flex items-center justify-center hover:bg-black/70 active:scale-95 transition-all group touch-manipulation">
                              <svg
                      ...
                      {/* Right Panel - Content */}
                      <div className="p-4 min-[375px]:p-5 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-between">
                        {/* Logo */}
                        <div className="mb-3 min-[375px]:mb-4 sm:mb-5 md:mb-6">
                          <h3 className="text-white text-xl min-[375px]:text-2xl sm:text-3xl md:text-4xl font-bold mb-2 min-[375px]:mb-3 sm:mb-4 leading-tight">
                            {story.brand}
                          </h3>
                          ...
                          <div className="inline-flex items-center gap-1.5 min-[375px]:gap-2 px-2.5 min-[375px]:px-3 py-1 min-[375px]:py-1.5 sm:px-4 sm:py-2 bg-black rounded-lg border border-teal-400/60 mb-3 min-[375px]:mb-4 sm:mb-5 md:mb-6">
                            <svg
                              className="w-3 h-3 min-[375px]:w-3.5 min-[375px]:h-3.5 sm:w-4 sm:h-4 text-teal-400 flex-shrink-0"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                          ...
                          {/* Name and Title */}
                          <h4 className="text-white text-base min-[375px]:text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-1 min-[375px]:mb-1.5 sm:mb-2 leading-tight">
                            {story.name}
                          </h4>
                          ...
                          {/* Description */}
                          <p className="text-white/80 text-[11px] min-[375px]:text-xs sm:text-sm md:text-base leading-relaxed mb-4 min-[375px]:mb-5 sm:mb-6 md:mb-8">
                            {story.description}
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col min-[375px]:flex-row gap-2 min-[375px]:gap-2.5 sm:gap-3">
                          ...
                          {story.hasVideo && (
                            <button className="px-4 min-[375px]:px-5 py-2 min-[375px]:py-2.5 sm:px-6 sm:py-3 bg-teal-500 text-white rounded-lg font-bold text-[11px] min-[375px]:text-xs sm:text-sm hover:bg-teal-600 active:scale-95 transition-all flex items-center justify-center gap-1.5 min-[375px]:gap-2 touch-manipulation min-h-[40px] min-[375px]:min-h-[44px]">
                              <svg
                                className="w-3.5 h-3.5 min-[375px]:w-4 min-[375px]:h-4 sm:w-5 sm:h-5 flex-shrink-0"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                              >
                                <path d="M8 5v14l11-7z" />
