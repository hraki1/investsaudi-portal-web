...
const hero: Hero = {
  ...
  content: {
    ...
    subtitleKey:
      "Find opportunities to invest in Saudi Arabia from Giga Projects, Joint Ventures, City Facility, Manufacturing, Services and more.",
  },
  search: {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full container mx-auto px-4 sm:px-6 md:px-12 lg:px-12 pb-8 sm:pb-12 md:pb-20 lg:pb-[8vh]">
        ...
        {/* Actions */}
        <div className="flex flex-col gap-6 sm:gap-8 lg:flex-row md:justify-between md:items-end">
          {/* Highlight cards */}
